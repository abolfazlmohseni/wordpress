        ...
        <div class="grid mx-4 grid-cols-1  sm:grid-cols-2 md:grid-cols-3 gap-10 sm:mx-2.5">
            ...
            if ($query->have_posts()) {
                while ($query->have_posts()) {
                    ...
                    $price = get_post_meta(get_the_ID(), 'discountprice', true);
                    $orgprice = get_post_meta(get_the_ID(), 'price', true);
                    ...
                    $DiscountPercentage = get_post_meta(get_the_ID(), 'Discountpercentage', true);
                    if ($DiscountPercentage) {
                        echo '<div class="rounded-md p-1 bg-red-600 text-white"><p>' . esc_html($DiscountPercentage) . '%' . '</p></div>';
                    }
                    ...
                    echo '<a class="w-1/2 py-1.5 px-2.5 rounded-lg bg-gray-200 text-gray-500 text-center">مشاهده جزئيات</a>';
                    echo '</div>';
